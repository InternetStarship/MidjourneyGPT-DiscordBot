...
const generate = async draft => {
  const conversation = [
    {
      role: 'system',
      content: `You help create text prompts for an AI text-to-image software called Midjourney. You will take concepts and make 4 variations of it as a Midjourney prompt with a Ad-lib version with keywords in backets like [backgrond], [time period], [style], etc. Always return your response inside of triple backtick code blocks. Do not provide explanation. Here is information about Midjourney as well as a prompt guide:
      About Midjourney:
    ...
    {
      role: 'user',
      content: `Give 4 Midjourney prompts with adlib versions for this concept: "${draft}"`,
    },
  ]
