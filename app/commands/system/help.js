...
\> **Advanced Editing**
\> Any attribute can be edited in the **advanced** input in the **/formula-imagine** command. You can use the following format to edit any dynamic attribute in the formula like this \`[time of day=night]\` or \`[perspective=far]\` and so on depending what is in the formula. 
